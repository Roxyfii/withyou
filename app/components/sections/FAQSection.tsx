...
export default function FAQSection() {
    return (
        <section className="bg-gray-600" id="faq" style={{ position: "relative", zIndex: 1, padding: "120px 0", background: "" }}>
            <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 clamp(16px, 4vw, 40px)" }}>
                <AnimatedSection>
                    <div style={{ textAlign: "center", marginBottom: 64 }}>
                        <span style={{
                            ...
                            letterSpacing: "0.22em", textTransform: "uppercase" as const, color: "#fff",
                        ...
                        <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 400, color: "#fff", lineHeight: 1, letterSpacing: "-0.03em" }}>
                            Pertanyaan <span style={{ fontStyle: "bold", color: "#cda" }}>yang Sering Ditanya.</span>
                        </h2>
                    </div>
                </AnimatedSection>
                        ...
                        <AnimatedSection key={i} delay={i * 80}>
                            <details style={{
                                ...
                                <summary style={{
                                    ...
                                    fontWeight: 700, color: "#ffff",
                                    display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16,
                                    cursor: "pointer", userSelect: "none" as const,
                                    listStyle: "none",
                                }}>
                                    {item.q}
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffff" strokeWidth={2.5} style={{ flexShrink: 0 }}>
                ...
                <AnimatedSection delay={500}>
                    <div style={{ textAlign: "center", marginTop: 56 }}>
                        ...
                        <a
                            href="https://wa.me/6289602203266?text=Halo%20Digital%2withyou!%20Saya%20punya%20pertanyaan%20tentang%20produk%20kalian."
