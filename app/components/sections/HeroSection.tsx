...
export default function HeroSection() {
    ...
    return (
        <>
            ...
            {/* ── HERO ── */}
            <section className="bg-gray-600 text-amber-50" id="hero" style={{ position: "relative", zIndex: 1, paddingTop: "clamp(80px, 12vh, 120px)", paddingBottom: "clamp(80px, 12vh, 130px)" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "60px" }}>
                    ...
                    <div className="text-white" style={{ flex: "1 1 400px", position: "relative", display: "flex", justifyContent: "center" }}>
                        <AnimatedSection delay={100}>
                            <div style={{ position: "relative", display: "inline-block" }}>
                                ...
                                <div style={{
                                    ...
                                    right: 0,
                                    height: "25%",
                                    background: "linear-gradient(to bottom, transparent 0%, #0x000 100%)",
                                    pointerEvents: "none"
                                }} />
                                ...
                                <div className="hero-badge-1" style={{
                                    ...
                                    <p style={{ margin: 0, fontSize: '11px', fontWeight: 600, color: '#ffff', textAlign: 'left', lineHeight: 1.3 }}>Akses Instan<br/>tanpa menunggu</p>
                                </div>

                                {/* Floating Badge 2: Hubungi Kami */}
                                <a href="https://wa.me/6289602203266?text=Halo%20Digital%20Atelier!%20Saya%20ada%20pertanyaan." target="_blank" rel="noopener noreferrer" className="hero-badge-2" style={{
                                    position: 'absolute',
                                    bottom: '20%',
                                    background: '#fff',
                                    padding: '12px 16px',
                                    ...
                                    <p style={{ margin: 0, fontSize: '10px', color: '#0x000', marginBottom: 2 }}>Ada pertanyaan?</p>
                    ...
                    <div style={{ flex: "1 1 500px", textAlign: "left" }} className="hero-text-container">
                        ...
                        <AnimatedSection delay={100}>
                            ...
                            <h2 style={{
                                ...
                                letterSpacing: "-0.02em", color: "#fff", marginTop: 0, marginBottom: 24,
                            }}>
                                The one And Only<br />
                                <span style={{ fontStyle: "bold", color: "#fff" }}>Gifting.</span>
                            </h2>
                        </AnimatedSection>
                        ...
                        <AnimatedSection delay={200}>
                            <p style={{
                                ...
                                Kado kejutan website romantis untuk si dia, siap dalam 1 menit. Mulai dari <strong style={{ color: '#ffff', fontWeight: 800 }}>Rp 15.000.</strong>
                            </p>
                        </AnimatedSection>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "nowrap", width: "100%", maxWidth: "400px", marginBottom: 20 }}>
                                ...
                                <a
                                    ...
                                    style={{
                                        flex: 1, display: "flex", justifyContent: "center", alignItems: "center", gap: 8,
                                        padding: "14px 0", borderRadius: 999,
                                        background: "transparent", color: "#ffff",
                                        fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase",
                                        textDecoration: "none", transition: "all 0.3s ease",
                        ...
                        <AnimatedSection delay={450}>
                            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 16 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                    <span style={{ fontFamily: "var(--font-sans)", fontSize: "17px", fontWeight: 800, color: "#ffff" }}>
                                        800+ Happy Customers
                                    </span>
                                ...
                                <div style={{ display: "flex", alignItems: "center", marginLeft: 4 }}>
                                    {[
                                        ...
                                        <div key={i} style={{
                                            ...
                                            color: "#0x000", fontSize: 13, fontWeight: 800, fontFamily: "var(--font-sans)",
                                    ...
                                    <div style={{
                                        height: 34, borderRadius: 999, background: "#0x000",
                                        display: "flex", alignItems: "center", justifyContent: "center",
