...
export default function CollectionSection() {
    ...
    return (
        <section className="bg-gray-600" id="collection" style={{ position: "relative", zIndex: 1, padding: "120px 0 40px" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 12, marginBottom: 28 }}>
                    <div>
                        ...
                        <h2 style={{
                            ...
                            Temukan <span style={{ fontStyle: "italic", color: "#cda" }}>Gift-mu</span>
                        </h2>
                    </div>
